...
# правильном месте каждого из шести файлов, а не просто что "AC-" где-то
# встречается в файле.
...
check_ac_doc "spec-template: критерии приёмки нумеруются AC-1, AC-2, …" \
...
check_ac_doc "skills/tdd: тег в имени describe/it" \
  "$KIT/skills/tdd/SKILL.md" 'it("AC-3'
check_ac_doc "skills/tdd: для bash-тестов тег в строке описания" \
  "$KIT/skills/tdd/SKILL.md" "в строке описания"
check_ac_doc "skills/tdd: правило тегирования называет bash-тесты" \
  "$KIT/skills/tdd/SKILL.md" "для bash-тестов"
check_ac_doc "skills/tdd: ссылка на ac-check.sh" \
